                ...
                <tbody>
                    ...
                    <?php foreach ($menu as $m) : ?>
                        <tr>
                            ...
                            <td><?= $m['menu']; ?></td>
                            <td>
                                <button href="#" class= "badge badge-success" data-toggle="modal"
                                data-popup="tooltip" data-placeholder="top" title="edit"
                                data-target="#exampleModalmenuedit<?=$m['id']; ?>">Edit</button>
                                <button onclick="hapusMenu('<?= base_url('menu/hapus/') . $m['id'] ?>')"
