...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <a href="" class="btn btn-primary mb-3" class="btn btn-primary" data-toggle="modal" data-target="#AddnewRole">Add Role</a>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('admin/roleaccess/') . $r['id']; ?>"
                                 class="badge badge-warning btn-sm">Access</a>
                                <button href="#" class="btn btn-success" data-toggle="modal"
                                 data-target="#roledit<?= $r['id']; ?>">Edit</button>
...
<?php foreach ($role as $r) : ?>
    <div class="modal fade" id="roledit<?= $r['id'] ?>" tabindex="-1" aria-labelledby="newMenuModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
